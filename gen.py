...
html.light{
  --bg:#f4efe6; --panel:#faf6ee; --fg:#4a443c; --dim:#6f6759; --line:#e0d8c9;
  --btn:#ebe4d7; --btnfg:#4a443c; --acc:#8a5f12;
  --tok-kw:#8c4a72; --tok-str:#5f6f2a; --tok-com:#6f6759; --tok-num:#8a5a1e; --tok-fn:#3f5f86; --tok-type:#2f6b63; --tok-del:#a03c32; --sel:rgba(138,95,18,.18); --sel:rgba(138,95,18,.14);
  color-scheme:light;
