...
- режим книги: страницы с мгновенным переворотом, счётчик `2 / 134`, стрелки ‹ ›, клавиши ←/→, PgUp/PgDn; колесо в книге молчит, длинные строки переносятся, продолжения с отступом 2ch, страница не выше окна и не висит полупустой (монстр-строка листается куском, который подклеивается к недобитой странице)
