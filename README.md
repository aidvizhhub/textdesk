...
![картинка символами](docs/symbols.png)
...
- «символы»: кнопка внизу превращает картинку в текст из знаков (ascii) — можно искать, копировать и читать в книге; кнопка «картинка» возвращает изображение, запись по-прежнему запрещена
